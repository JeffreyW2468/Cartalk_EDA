...
class CarTalkWebscraper:
    ...
    def runApplication(self, baseURL):
        ...
        self.driver.get('https://community.cartalk.com/c/safety/9') #https://community.cartalk.com/c/general-discussion/8
        count = 0
        ...
        jsonFilename = 'CarTalk_Topic_Attributes_' + timeStamp + '.json'
        csvFilename = 'CarTalk_Topic_Attributes_' + timeStamp + '.csv'
